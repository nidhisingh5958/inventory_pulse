#!/usr/bin/env python3
"""
Populate Google Sheets with Dummy Inventory Data

This script adds sample inventory data to the specified Google Sheets spreadsheet
for testing the inventory management system.
"""
...
class SheetsPopulator:
    ...
    def populate_sheets(self):
        ...
        print(f"📊 Spreadsheet URL: https://docs.google.com/spreadsheets/d/{self.config.google_sheets_spreadsheet_id}")
        ...
        if success:
            ...
            print(f"🔗 View your spreadsheet: https://docs.google.com/spreadsheets/d/{self.config.google_sheets_spreadsheet_id}")
            print("\n📋 Data Summary:")
